...
RSpec.describe 'Core - Channel Message', type: :request, feature: true do
  ...
  it 'able to delete message from channel'
  it 'able to edit message in channel'
  it 'able to upload approved files to channel'
  it 'able to delete uploaded files from channel'
end
